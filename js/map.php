...
<div id="map" style="width: 100%; height: 800px; background-color: gray"></div>    
<?
require_once("includes/main.inc.php");
?>
...
$result=mysql_query($query);
{
    if ($num=mysql_numrows($result)) {
        ...
        while ($i < $num) {
            ...
            echo "['<div><h4>$title</h4><br><p>Estado: $status</p><a href=view_passenger.php?pid=$driver_id>Ver conductor $id</a></div>', $lapt, $long, '$status'],";
            $i++;
        }
    }
}
