                    ...
                    <table class="table table-bordered tableList">
                        ...
                        while ($line_raw = ms_stripslashes(mysql_fetch_array($result))) {
                            ...
                            <tr class="<?= $css ?>">
                                ...
                                <td><a class="btn btn-default btn-sm btn-icon icon-left" href="driver_add.php?id=<?= $line_raw['id'] ?>&set_flag=update<?= $_REQUEST[parent_id] != '' ? '&parent_id=' . $_REQUEST[parent_id] : '' ?>"><i class="entypo-pencil"></i>Editar</a></td>
